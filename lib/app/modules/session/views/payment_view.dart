                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                            ...
                            Column(
                              ...
                              children: [
                                GestureDetector(
                                  ...
                                  child: Text(
                                      '${idrFormatter(value: sessionController.boxPrice.read(priceInit)) ?? 0}',
                      ...
                      Expanded(
                        child: Padding(
                          padding: const EdgeInsets.only(left: 20.0, right: 20.0, bottom: 15, top: 15.0),
                          child: Container(
                      ...
                      GestureDetector(
                        onTap: () async {
                          sessionController.sendWhatsAppConfirm(
                              phone: '6287847536123', bill: '40000', nomerOrder: '1212d3242', time: 'hari ini');
                        },
                        child: Padding(
